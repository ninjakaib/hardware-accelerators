...
from hardware_accelerators.nn.precision_eval import compare_precision_inference, detailed_precision_comparison

def main():
    # Parse command line arguments
    parser = argparse.ArgumentParser(description="Train and evaluate precision differences")
    parser.add_argument(
        "--detailed", 
        action="store_true",
    ...
    # Run comparison
    if args.detailed:
        print(f"Running detailed comparison with {args.trials} trials for each batch size...")
