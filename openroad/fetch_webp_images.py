...
def main():
    ...
    if not os.path.exists(WSL_REPORTS_PATH):
        print(
            f"Error: WSL WebP path '{WSL_REPORTS_PATH}' does not exist or is not accessible."
        )
    ...
    for design in designs:
        ...
        webp_source_path = os.path.join(
            WSL_REPORTS_PATH, design, "base", "final_resized.webp"
        )
