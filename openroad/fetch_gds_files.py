...
import subprocess
import sys
from data_transfer import SOURCE_DIR, SOURCE_DIR2, GDS_DIR, WSL_RESULTS_PATH, ensure_directory
...
def main():
    ...
    if not os.path.exists(WSL_RESULTS_PATH):
        print(f"Error: WSL GDS path '{WSL_RESULTS_PATH}' does not exist or is not accessible.")
